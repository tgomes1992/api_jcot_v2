...
@app.get("/statusPassivo", tags=["Status Passivo"]  ,summary="Status do Passivo dos Fundos de Investimento" , 
                          description="PStatus do fundo no Passivo de fundos de investimento da Oliveira Trust" )
async def movimentacaocot():
...
@app.get("/posicao-fundo" , tags=["Posição"]  ,summary="Consulta de Posição no jcot por cnpj de fundo" , 
...
async def posicaojcot(data: date  ,  cd_cotista: str ):
    '''Retorna a consulta de posição diária por cnpj de fundo e por data'''
